...
def assign_jobs(output_file_name,job_assignments,real_edges,n_gates,IO_list = [200,150],population_file_template = "../genetic_alg/static_files/pop_file.xml",):
    ...
    for idx, gate_edge_id in enumerate(gates):
        ...
        incoming_val = n_gates[idx,0]
        outgoing_val = n_gates[idx,0]
